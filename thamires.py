...
garra1.on_for_seconds(SpeedPercent(10), 0.5) #garra da esquerda abre
garra2.on_for_seconds(SpeedPercent(-10), 0.5) #garra da direita abre
...
time.sleep(1)
garra1.on_for_seconds(SpeedPercent(-10), 0.3) #garra da esquerda fecha
garra2.on_for_seconds(SpeedPercent(10), 0.35) #garra da direita fecha
